...
filename1 = r"TD1/Exercice_1/e1.2/premier.txt"  # Nom du fichier source en lecture
new_filename = r"TD1/Exercice_1/e1.2/deux.txt"  # Nom du fichier de destination en écriture
